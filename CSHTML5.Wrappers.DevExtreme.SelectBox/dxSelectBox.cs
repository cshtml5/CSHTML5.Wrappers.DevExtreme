...
using CSHTML5.Wrappers.DevExtreme.SelectBox;
    ...
    public partial class dxSelectBox : JSComponent
    {
        ...
        public IEnumerable DataSource
        {
            ...
            set
            {
                ...
                option("dataSource", Utils.ToJSObject(_dataSource));
            }
        }
        ...
        public Boolean SearchEnabled
        {
            ...
            set
            {
                ...
                option("searchEnabled", Utils.ToJSObject(_searchEnabled));
            }
        }
...
To do so, please follow the tutorial at: http://www.cshtml5.com"); //todo: put the address of the tutorial.
        ...
        private void SetSelectBoxOnValueChanged()
        {
            Action<object> currentSelectedItem = (Action<object>)this.GetCurrentSelectBoxItem;

            Interop.ExecuteJavaScript(@"$0.option('onValueChanged', function (e) {
                var selectedItem = e.component.option('selectedItem');
                $1(selectedItem);
            });", UnderlyingJSInstance, currentSelectedItem);
        }
        ...
        private void GetCurrentSelectBoxItem(Object selectedItem)
        {
